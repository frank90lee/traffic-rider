...
export const postsData: Record<string, Record<string, { data: Record<string, unknown>, content: string }>> = {
  "en": {
    "blocky-rider": {
      "data": {
        "title": "Blocky Rider – Free Online Motorcycle Game (No Download)",
        "name": "Blocky Rider",
        "description": "Play Blocky Rider online for free in your browser. Dodge unpredictable traffic in a voxel city, switch camera views, unlock bikes, and master Race, Demolition, and City modes—no download.",
        "gameSrc": "https://trafficroad.io/blocky-rider.embed",
        "features": [
          {
            "title": "Three Modes, Three Moods",
            "description": "Race for distance, smash cars for points in Demolition, or cruise the city with zero pressure. In Blocky Rider, each mode feels like a different game.",
            "icon": "Zap"
          },
          {
            "title": "Pure Skill, No Upgrades",
            "description": "No boosts, no shields, no stat grinding—Blocky Rider is all timing, spacing, and lane-reading under real traffic chaos.",
            "icon": "Target"
          },
          {
            "title": "Camera Control Matters",
            "description": "Tap C to change perspectives and pick the view that shows you the most road. In Blocky Rider, one better angle can save an entire run.",
            "icon": "Eye"
          },
          {
            "title": "Wheelies & Handbrake Depth",
            "description": "Distance unlocks wheelie and handbrake play, adding risk-reward scoring and sharper corrections when the highway gets crowded.",
            "icon": "Gauge"
          }
        ],
        "steps": [
          {
            "title": "Learn the Blocky Rider Inputs",
            "items": [
              ...
              "If available: Space can act as handbrake (after you unlock it in some versions)"
            ]
          },
          {
            "title": "Pick a Mode With Intent",
            "items": [
              "Blocky Rider Race Mode: survive as long as possible; distance is your score",
              "Blocky Rider Demolition Mode: score by crashing into vehicles; keep momentum",
              "Blocky Rider City Mode: explore and practice with no timer and no game-over pressure"
            ]
          },
          {
            "title": "Play for Clean Progress",
            "items": [
              "Collect coins during runs to unlock bikes",
              "Use City Mode to learn ramps/airport areas and test handling safely",
              "Unlock wheelie (around 2 km) and handbrake (around 5 km) as you keep riding"
            ]
          }
        ],
        "faq": [
          {
            "question": "Is Blocky Rider free to play online?",
            "answer": "Yes. You can play Blocky Rider for free in your browser—no download required."
          },
          {
            "question": "What are the controls for Blocky Rider?",
            "answer": "Use WASD or Arrow Keys to accelerate, brake, and steer. Press C to switch camera view. Some versions also support a handbrake (often Space) after it unlocks."
          },
          {
            "question": "What are the three game modes in Blocky Rider?",
            "answer": "Race Mode is an endless survival run where distance equals score. Demolition Mode is a time-limited mode where you crash into vehicles to score. City Mode is free roam for exploration and practice."
          },
          {
            "question": "How do you unlock bikes in Blocky Rider?",
            "answer": "Collect coins and keep riding. Over time you can unlock multiple bikes (commonly Cross, Superbike, and Police), each with a different handling feel."
          },
          {
            "question": "How do you unlock wheelie and handbrake?",
            "answer": "Many versions unlock wheelie after about 2 km of total riding and unlock handbrake around 5 km. The exact milestone can vary slightly by portal build."
          },
          {
            "question": "Does Blocky Rider have upgrades or power-ups?",
            "answer": "Most versions don’t. Blocky Rider is usually described as skill-based: no upgrades, no boost power-ups, and no shields—your run is decided by control and decisions."
          },
          {
            "question": "What’s the best way to score higher in Race Mode?",
            "answer": "Manage speed, stay calm in traffic clusters, and use the camera view that gives you the best visibility. Coins and risky close passes can boost scoring in some versions, but survival is the real multiplier."
          }
        ]
      },
